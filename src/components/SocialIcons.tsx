  ...
  return (
    <div className="icons-section">
      <div className="social-icons" data-cursor="icons" id="social">
        <span>
          <a href="https://github.com/Shubhamverma2221" target="_blank" rel="noreferrer">
            <FaGithub />
          </a>
        </span>
        <span>
          <a href="https://linkedin.com/in/shubhamverma2221" target="_blank" rel="noreferrer">
            <FaLinkedinIn />
          </a>
        </span>
        <span>
          <a href="https://leetcode.com/u/Shubhamverma2221/" target="_blank" rel="noreferrer">
            <SiLeetcode />
          </a>
        </span>
      </div>
